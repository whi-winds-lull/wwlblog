...
(() => {
    ...
    var xo = Object.getOwnPropertyNames, Kr = Object.getOwnPropertySymbols, bo = Object.getPrototypeOf,
        Yr = Object.prototype.hasOwnProperty, yo = Object.prototype.propertyIsEnumerable;
    var Jr = (e, r, t) => r in e ? Tr(e, r, {enumerable: !0, configurable: !0, writable: !0, value: t}) : e[r] = t,
        Ke = (e, r) => {
    ...
    var go = (e, r, t, o) => {
        if (r && typeof r == "object" || typeof r == "function") for (let n of xo(r)) !Yr.call(e, n) && n !== t && Tr(e, n, {
            get: () => r[n],
            ...
            R = 150, a = 20, E = 150, u = .75, X.score = function (h, b, S) {
                ...
                for (H = -1; ++H < j;) {
                    ...
                    for (fe = 0, wr = 0, _ = 0, ve = !0, M = !0, I = -1; ++I < q;) {
                        if (Qe = Oe[I], Qe > fe && (fe = Qe), U = 0, te[I] === Sr) if (Er = s(H, h, b), U = _ > 0 ? _ : l(h, b, de, te, H, I, Er), g = wr + p(H, I, Er, y, U), g > fe) fe = g, re = V; else {
                ...
                for (y = 0, V = 0, re = 0, I = 0, _ = -1, F = -1; ++F < M;) {
                    if (H = T[F], i(H)) if (_ = b.indexOf(H, _ + 1), _ > -1) {
                        V++;
                        continue
                    } else break;
                    for (; ++_ < U;) if (H === b[_] && s(_, h, b)) {
                        S[F] === h[_] && I++, re += _, y++;
                        break
                    }
                    if (_ === U) break
    ...
    var yr = Te(De => {
        (function () {
            ...
            a = qe(), i = a.isMatch, e = a.computeScore, s = a.scoreSize, u = 20, t = 2.5, De.score = function (c, p, l) {
                ...
                for (; ++d < p;) if (c[d] === l) for (v++; ++d < p && c[d] === l;) ;
                return v
        ...
        (function () {
            ...
            a = qe(), t = a.isMatch, o = a.isWordStart, u = a.scoreConsecutives, s = a.scoreCharacter, f = a.scoreAcronyms, gr.match = n = function (c, p, l) {
                ...
                for (x = "", v = -1, w = 0; ++v < m.length;) {
                    for (d = m[v], d > w && (x += c.substring(w, d), w = d); ++v < m.length;) if (m[v] === d + 1) d++; else {
                        v--;
                        break
                    }
                ...
                for (y = -1; ++y < _;) for (V = 0, ae = 0, b = 0, de = p[y], g = -1; ++g < M;) T = 0, R = 0, re = ae, j[g] === de && (te = o(y, c, p), T = b > 0 ? b : u(c, p, I, j, y, g, te), R = re + s(y, g, te, E, T)), ae = q[g], b = S[g], V > ae ? U = m : (V = ae, U = w), R > V ? (V = R, U = d) : T = 0, q[g] = V, S[g] = T, ve[++H] = V > 0 ? U : x;
...
***************************************************************************** */
    var _r = function (e, r) {
        return _r = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (t, o) {
            t.__proto__ = o
        } || function (t, o) {
  ...
  `) : "", this.name = "UnsubscriptionError", this.errors = t
    ...
    var oe = function () {
        ...
        return e.prototype.unsubscribe = function () {
            ...
            var t;
            if (r && r !== this) if (this.closed) et(r); else {
                if (r instanceof e) {
    ...
    function Ae(e) {
        if (ee.useDeprecatedSynchronousErrorHandling) {
            ...
            if (r && (be = {errorThrown: !1, error: null}), e(), r) {
                var t = be, o = t.errorThrown, n = t.error;
    ...
    var C = function () {
        ...
        return e.prototype.lift = function (r) {
            ...
            var n = this, i = _o(r) ? r : new ye(r, t, o);
            return Ae(function () {
                var f = n, s = f.operator, u = f.source;
    ...
    var Ce = {
        schedule: function (e) {
            var r = requestAnimationFrame, t = cancelAnimationFrame, o = Ce.delegate;
    ...
    var B = function (e) {
        ...
        return r.prototype.lift = function (t) {
            ...
            var o = this, n = this, i = n.hasError, f = n.isStopped, s = n.observers;
    ...
    var ct = function (e) {
        ...
        return r.prototype.next = function (t) {
            var o = this, n = o.isStopped, i = o._buffer, f = o._infiniteTimeWindow, s = o._timestampProvider,
                u = o._windowTime;
            ...
            var t = this, o = t._bufferSize, n = t._timestampProvider, i = t._buffer, f = t._infiniteTimeWindow,
                s = (f ? 1 : 2) * o;
    ...
    var Uo = Array.isArray, zo = Object.getPrototypeOf, Vo = Object.prototype, $o = Object.keys;
    ...
    function Re() {
        for (var e = [], r = 0; r < arguments.length; r++) e[r] = arguments[r];
        var t = ne(e), o = Le(e), n = Et(e), i = n.args, f = n.keys;
    ...
    function No(e, r, t) {
        return t === void 0 && (t = G), function (o) {
            Tt(r, function () {
    ...
    var qo = ["addListener", "removeListener"], Do = ["addEventListener", "removeEventListener"], Qo = ["on", "off"];
    ...
    function D(e, r, t, o) {
        ...
        }) : Ko(e) ? qo.map(It(e, r)) : Jo(e) ? Qo.map(It(e, r)) : [], 2), i = n[0], f = n[1];
    ...
    function Lt(e) {
        return A(function (r, t) {
            var o = !1, n = null, i = null, f = !1, s = function () {
    ...
    function Wr(e, r) {
        return r === void 0 && (r = ge), A(function (t, o) {
            var n = null, i = null, f = null, s = function () {
                if (n) {
    ...
    function kt(e) {
        ...
        var r = e.connector, t = r === void 0 ? function () {
                return new B
            } : r, o = e.resetOnError, n = o === void 0 ? !0 : o, i = e.resetOnComplete, f = i === void 0 ? !0 : i,
            s = e.resetOnRefCountZero, u = s === void 0 ? !0 : s;
        return function (a) {
            var c, p, l, v = 0, d = !1, m = !1, x = function () {
    ...
    function $t(e, r) {
        if (typeof r == "string" || typeof r == "number") e.innerHTML += r.toString(); else if (r instanceof Node) e.appendChild(r); else if (Array.isArray(r)) for (let t of r) $t(e, t)
    }
    ...
    function Nt(e) {
        ...
        return Se(() => (document.head.appendChild(r), N(D(r, "load"), D(r, "error").pipe(Q(() => kr(() => new ReferenceError(`Invalid script: ${e}`))))).pipe(P(() => {
        }), le(() => document.head.removeChild(r)), ke(1))))
    }
    ...
    var en = new B, Pp = Se(() => ie(new IntersectionObserver(e => {
        for (let r of e) en.next(r)
    }, {threshold: 0}))).pipe(Q(e => N(je, ie(e)).pipe(le(() => e.disconnect()))), me(1));

    function Qt(e, r = 16) {
        return Vt(e).pipe(P(({y: t}) => {
            let o = qt(e), n = Dt(e);
            return t >= n.height - o.height - r
        }), pe())
    }

    var $p = {drawer: Z("[data-md-toggle=drawer]"), search: Z("[data-md-toggle=search]")};
    var rn = Z("#__config"), Ne = JSON.parse(rn.textContent);
    ...
    function Gt(e) {
        let r = Ut(e), t = N(D(e, "keyup"), D(e, "focus").pipe(zr(1))).pipe(P(() => e.value), he(e.value), pe());
    ...
    function io(e, r) {
        return (0, ao.wrap)(e.shortcode, r, {wrap: {tagOpen: "<b>", tagClose: "</b>"}})
    }

    function fo(e, r, t) {
        return J("li", {class: "mdx-iconsearch-result__item"}, J("span", {class: "twemoji"}, J("img", {src: e.url})), J("button", {
    ...
    function uo(e) {
        let r = `@${e.name}`;
        return J("a", {href: e.url, title: r, class: "mdx-sponsorship__item"}, J("img", {src: e.image}))
    }
    ...
    function on(e, {index$: r, query$: t}) {
        switch (e.getAttribute("data-mdx-mode")) {
            case"file":
                return Re([t.pipe(xr("value")), r.pipe(P(({icons: o}) => Object.values(o.data).map(n => n.replace(/\.svg$/, ""))))]).pipe(P(([{value: o}, n]) => (0, Qr.filter)(n, o)), Q(o => r.pipe(P(({icons: n}) => ({
                    data: o.map(i => ({
                        shortcode: i,
            ...
            default:
                return Re([t.pipe(xr("value")), r.pipe(P(({
                                                              icons: o,
                                                              emojis: n
                                                          }) => [...Object.keys(o.data), ...Object.keys(n.data)]))]).pipe(P(([{value: o}, n]) => (0, Qr.filter)(n, o)), Q(o => r.pipe(P(({
                                                                                                                                                                                             icons: n,
                                                                                                                                                                                             emojis: i
                                                                                                                                                                                         }) => ({
                    data: o.map(f => {
    ...
    function so(e, {index$: r, query$: t}) {
        let o = new B, n = Qt(e).pipe(Ee(Boolean)), i = Z(":scope > :first-child", e);
        ...
        let f = e.getAttribute("data-mdx-mode") === "file", s = Z(":scope > :last-child", e);
        return o.pipe(Fe(() => s.innerHTML = ""), Q(({data: u}) => N(ie(...u.slice(0, 10)), ie(...u.slice(10)).pipe(Hr(10), $r(n), Q(([a]) => a)))), He(t)).subscribe(([u, {value: a}]) => s.appendChild(fo(u, a, f))), on(e, {
            query$: t,
            index$: r
        }).pipe(Fe(u => o.next(u)), le(() => o.complete()), P(u => Ke({ref: e}, u)))
    }

    function po(e) {
        let r = Kt(), t = br(new URL("assets/javascripts/iconsearch_index.json", r.base)),
            o = We("iconsearch-query", e), n = We("iconsearch-result", e), i = Gt(o), f = so(n, {index$: t, query$: i});
        return N(i, f)
    }

    function lo(e) {
        let r = br("https://3if8u9o552.execute-api.us-east-1.amazonaws.com/_/"), t = We("sponsorship-count"),
            o = We("sponsorship-total");
        return r.subscribe(n => {
            e.removeAttribute("hidden");
            let i = Z(":scope > :first-child", e);
            for (let f of n.sponsors) f.type === "public" && i.appendChild(uo(f.user));
            i.appendChild(co(n.sponsors.filter(({type: f}) => f === "private").length)), t.innerText = `${n.sponsors.length}`, o.innerText = `$ ${n.total.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} a month`
